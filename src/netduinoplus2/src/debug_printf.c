...
#include "debug_printf.h"
	...
	#define DEBUG_SEND_HOOK(c)	{USART_SendData(NP2_DEBUG_UART, c); while (USART_GetFlagStatus(NP2_DEBUG_UART, USART_FLAG_TC) == RESET); USART_ClearFlag(NP2_DEBUG_UART, USART_FLAG_TC);}
#else
	#define DEBUG_SEND_HOOK(c)	VCP_sendchar(c);
#endif
unsigned long
